...
class ProductManager {
  ...
  updateProducts = async(id, product)=>{
    ...
    const productOlds = await this.readProducts();
    const products = [{...product, id : id}, ...productOlds]; // borra todo el cuerpo del producto y 
    await this.writeProducts(products) // concatena el id anterior con el nuevo cuerpo del producto
